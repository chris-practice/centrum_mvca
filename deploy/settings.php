 ...
 * site administrators to ssssecurely install missing updates for the site
...
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/pfcentrumvca/pfcentrumvca-settings.inc');
}
...
// Disable default user registration email (just in case).
$conf['user_mail_register_no_approval_required_notify'] = FALSE;
$conf['securepages_enable'] = 0;


// Centrum link
$base_url = 'http://wamp.centrumca';
$db_url = 'mysqli://root@127.0.0.1:3306/centrumca';
$databases = array(
    'default' => array(
        'default' => array(
            'driver' => 'mysql',
...
// Link to the local files folder (optional)
